    ...
    >
      <el-tabs tab-position="left" >
        <el-tab-pane label="首页配置">
          ...
          <el-form-item label="精选推荐栏目商品显示数量" prop="litemall_wx_index_hot">
            <el-input v-model="dataForm.litemall_wx_index_choice"/>
          </el-form-item>
          <el-form-item label="热销推荐栏目商品显示数量" prop="litemall_wx_index_hot">
      ...
      <el-form-item>
        ...
        <el-button v-permission="['POST /admin/config/wx']" type="primary" @click="update">确定</el-button>
      </el-form-item>
    </el-form>
