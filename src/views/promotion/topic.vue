<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-button v-permission="['GET /admin/topic/list']" :loading="downloadLoading" class="filter-item" type="primary" icon="el-icon-download" @click="handleDownload">导出</el-button>
    </div>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="dataForm" status-icon label-position="left" label-width="100px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="背景色" prop="topicBackgroundColor">
          <el-color-picker v-model="dataForm.topicBackgroundColor"/>
        </el-form-item>
        <el-form-item label="购物车背景色" prop="cartBackgroundColor">
          <el-color-picker v-model="dataForm.cartBackgroundColor"/>
        </el-form-item>
        <el-form-item label="标题颜色" prop="titleColor">
          <el-color-picker v-model="dataForm.titleColor"/>
        </el-form-item>
        <el-form-item label="副标题颜色" prop="subtitleFontColor">
          <el-color-picker v-model="dataForm.subtitleFontColor"/>
        </el-form-item>
        <el-form-item label="市场价颜色" prop="counterPriceColor">
          <el-color-picker v-model="dataForm.counterPriceColor"/>
        </el-form-item>
        <el-form-item label="惊爆价颜色" prop="retailPriceColor">
          <el-color-picker v-model="dataForm.retailPriceColor"/>
        </el-form-item>
        <el-form-item label="底部背景色" prop="onePackBgColor">
          <el-color-picker v-model="dataForm.onePackBgColor"/>
        </el-form-item>
        <el-form-item label="按钮背景色" prop="onePackBtnColor">
          <el-color-picker v-model="dataForm.onePackBtnColor"/>
        </el-form-item>
        <el-form-item label="按钮字体颜色" prop="onePackFontColor">
          <el-color-picker v-model="dataForm.onePackFontColor"/>
        </el-form-item>
      </el-form>
...
export default {
  ...
  data() {
    return {
      ...
      dataForm: {
        topicBackgroundColor: null,
        cartBackgroundColor: null,
        titleColor: null,
        subtitleFontColor: null,
        counterPriceColor: null,
        retailPriceColor: null,
        onePackBgColor: null,
        onePackBtnColor: null,
        onePackFontColor: null,
        goodsValue: [],
        id: undefined,
        titile: undefined,
        subtitle: undefined,
