<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-input v-model="listQuery.name" clearable class="filter-item" style="width: 200px;" placeholder="请输入物料名称"/>
      ...
      <el-select v-model="listQuery.brandId" clearable class="filter-item" placeholder="请选择所属供应商">
