<template>
  <div style="margin-top: 50px">
    <el-form :model="erpSpuVo" :rules="rules" ref="productInfoForm"  label-width="400px" style="width:70%;text-align:center" size="small">
      <el-form-item label="物料分类：" prop="categoryId" style="width:100%;text-align:left">
      ...
      <el-form-item label="商品品牌：" prop="brandId">
        <el-select v-model="erpSpuVo.brandId"  placeholder="请选择品牌" style="width:100%;text-align:left">
      ...
      <el-form-item label="保质期：" style="width:200%;text-align:left">
