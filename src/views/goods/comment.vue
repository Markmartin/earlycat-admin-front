<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-button v-permission="['GET /admin/comment/list']" class="filter-item" type="primary" icon="el-icon-search" @click="handleFilter">查找</el-button>
    ...
    <el-table v-loading="listLoading" :data="list" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      ...
      <el-table-column align="center" label="商品图">
        <template slot-scope="scope">
          <img :src="scope.row.goods ? scope.row.goods.picUrl : ''" style="width:80px;height:80px;" >
        </template>
      </el-table-column>
      ...
      <el-table-column align="center" label="操作" width="200" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button v-permission="['POST /admin/order/reply']" type="primary" size="mini" @click="handleReply(scope.row)">回复</el-button>
          <el-button v-permission="['POST /admin/comment/delete']" type="danger" size="mini" @click="handleDelete(scope.row)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :visible.sync="replyFormVisible" title="回复">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button v-permission="['POST /admin/order/reply']" type="primary" @click="reply">确定</el-button>
      </div>
    </el-dialog>
